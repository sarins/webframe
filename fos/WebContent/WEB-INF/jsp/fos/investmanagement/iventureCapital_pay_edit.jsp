...
<div class="widget">
    <div class="widgetTitle">
    	<span class="widgetTitleIco">资金支出</span>
        ...
        <table class="formInfo">
        	<tbody>
                ...
                <tr>
                    ...
                    <td class="formElem">
	     				<input type="text" name="firstCategoryName" id="firstCategoryName" class="inText" value="${sourceUseFunds.firstCategory.proCateName}" readonly="readonly"/>
	     				<input type="hidden" name="firstCategory" id="firstCategory" value="${sourceUseFunds.firstCategory.id}">
					</td>
                    <td class="formElem labelName"><span class="redmark">*</span><label>项目：</label></td>
                ...
                <tr>
                    ...
                    <td class="formElem moreTen" colspan="5">
                    	<textarea name="remarks" id="remarks"><c:out value="${sourceUseFunds.remarks}"></c:out></textarea>
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    <div class="editePageBtn">
    	<ul>
            ...
            <li><input type="hidden" name="subType" id="subType" value="${subType}"></li>
            <div class="clear"></div>
        </ul>
        <div class="clear"></div>
    </div>
...
function queryData(){
	...
	postDataByURL('iventureCapital.do?actionMethod=editQuery&initDate='+gatherDate,$('#sourceUseFundsForm').serialize(),'resultList');
}
function saveData(){
	trimForm('sourceUseFundsForm');
	postDataByURL('iventureCapital.do?actionMethod=edit',$('#sourceUseFundsForm').serialize(),'workspace');
}
function deleteData(sourceUseFundsId){
	postDataByURL('iventureCapital.do?actionMethod=delete&id='+sourceUseFundsId,$('#sourceUseFundsForm').serialize(),'workspace');
}
	/*
	清空查询条件操作
		*/
	function cleanData(){
		cleanText(['projectName','tenDaysMoney','tenDaysDate','aMonthMoney','aMonthDate','twoMonthsMoney','threeMonthsMoney','sixMonthsMoney','moreSixMonthsMoney','remarks']);
