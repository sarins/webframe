...
<c:set var="currentGridId" value="tb_funds_boss_table_list1"></c:set>
...
<div class="gridInfo">
    <div class="gridToolbar">
        <div class="gridHeaderName">汇总报表列表</div>
    ...
    <div class="grid">
        <table width="100%" class="resize" id="tb_funds_boss_table_list1">
            <thead>
                <tr>
				<th>序号</th>
				<th>统计日期</th>
            ...
            <tbody>
				...
				<tr <c:if test="${!(s.index%2==0) }"> class="tdbgcolor"</c:if>>
					...
					<td>
					<a href="#" onclick="getData('fundsOriginGather.do?actionMethod=gatherOriginPreview&gatherDate=${reportsDetails.gatherDate}','','workspace');">
					<c:out value="${reportsDetails.oneReportsName}"/>
					</a>
					</td>
					<td>
					<a href="#" onclick="getData('fundsApplyGather.do?actionMethod=gatherApplyPreview&gatherDate=${reportsDetails.gatherDate}','','workspace');">
					<c:out value="${reportsDetails.towReportsName}"/>
					</a>
					</td>
					<td>
					<a href="#" onclick="getData('fundsBalanceGather.do?actionMethod=gatherBalancePreview&gatherDate=${reportsDetails.gatherDate}','','workspace');">
					<c:out value="${reportsDetails.threeReportsName}"/>
					</a>
					</td>
			 </tr>
			</c:forEach>
