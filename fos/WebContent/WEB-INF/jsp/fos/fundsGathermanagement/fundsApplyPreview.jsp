...
<form:form modelAttribute="sourceUseFundsForm" name="ec" target="_blank" onsubmit="return false" action="fundsApplyGather.do?actionMethod=export">
<div class="operationTool">
	<ul>
    	<li><a href="javascript:;" title="查询结果导出Excel">
				<img src="${ht_globalUrl}/images/excel.jpg" width="55px" height="23px" onclick="exportApplyExcel();"/>
			</a>
		</li>
		<li>
...
<div class="gridInfo">
    ...
    <div class="grid">
        <table width="100%" border='1' class="resize" id="tb_apply_table_list">
            <thead>
                <tr>
				<th>项目分类</th>
				<th>项目</th>
