...
<form:form modelAttribute="fundsOriginGather" name="ec" target="_blank" action="fundsOriginGather.do?actionMethod=gatherExport">
...
<div class="gridInfo">
    <div class="gridToolbar">
        <div class="gridHeaderName">资金来源计划汇总列表</div>
       
        <div class="clear"></div>
    </div>
    <div class="grid">
        <table width="100%" border='1' class="resize" id="tb_fundsOrigin_gather_table_listsss">
            <thead>
                <tr>
				<th>一级项目分类</th>
				<th>二级项目分类</th>
