...
<form:form modelAttribute="sourceUseFundsForm" name="ec" onsubmit="return false" target="_blank" action="fundsApply.do?actionMethod=export">
<fieldset>
    	...
    	<table class="formInfo">
        	<tbody>
            	<tr>
                    ...
                    <td class="formElem">
                    	<input type="text" value="${t_firstCategory_proCateName}" name="ht_t.firstCategory.proCateName" id="ht_t_firstCategory_proCateName" class="inText"/>
                    </td>
...
function queryData(){
	postDataByURL('fundsApply.do?actionMethod=query',$('#sourceUseFundsForm').serialize(),'resultList');
}
	/*
	清空查询条件操作
		*/
	function cleanData(){
		cleanText(['ht_t_firstCategory_proCateName','ht_t_projectName']);
	}
