...
function postDataByURL(actionUrl,dataString,resultArea,successMessage,callBack){
	try{
		showProcess();
		hidenSuccessMessage();
		hidenErrorMessage();
...
function showDiv(div_id) {
	 if(!$("#"+div_id)[0]){
	    	$("<div id='"+div_id+"' style='display: none;'><img src='"+globalUrl+"images/icons/loading.gif' alt='正在加载.....' /></div>").appendTo("body");
	    }
    var div_obj = $("#"+div_id);
